...
{
    /// <summary>
    /// Provides access to all Database operations needed for BASEL - PD - Monitoring Item.
    /// </summary>
    public class PdMonitoringItemManager
    {
        ...
        {
            await (new PdMonitoringItemWriter()).InsertRecordAsync(newRecord);
        }
