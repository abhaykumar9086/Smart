...
{
    /// <summary>
    /// Provides access to all Database operations needed for BASEL - EAD - Accuracy.
    /// </summary>
    public class EadAccuracyManager
    {
        ...
        {
            await (new EadAccuracyWriter()).InsertRecordAsync(newRecord);
        }
