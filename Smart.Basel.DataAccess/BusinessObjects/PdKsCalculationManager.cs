...
{
    /// <summary>
    /// Provides access to all Database operations needed for BASEL - PD - KS Calculation.
    /// </summary>
    public class PdKsCalculationManager
    {
        ...
        {
            await (new PdKsCalculationWriter()).InsertRecordAsync(newRecord);
        }
