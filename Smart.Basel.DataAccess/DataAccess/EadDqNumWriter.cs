...
{
    /// <summary>
    /// Provides access to all Database Write operations needed for BASEL - EAD - Delinquent (Numeric).
    /// </summary>
    internal class EadDqNumWriter
    {
        ...
        public async Task InsertRecordAsync(EadDqNum newRecord)
        {
            ...
            await database.CreateStoredProcedureCommand(BaselDataAccessConstants.SP_ADD_EAD_DQ_NUM)
