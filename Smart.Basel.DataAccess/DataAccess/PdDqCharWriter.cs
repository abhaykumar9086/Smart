...
{
    /// <summary>
    /// Provides access to all Database Write operations needed for BASEL - PD - Delinquent (Characters).
    /// </summary>
    internal class PdDqCharWriter
    {
        ...
        public async Task InsertRecordAsync(PdDqChar newRecord)
        {
            ...
            await database.CreateStoredProcedureCommand(BaselDataAccessConstants.SP_ADD_PD_DQ_CHAR)
