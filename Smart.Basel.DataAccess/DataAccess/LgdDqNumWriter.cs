...
{
    /// <summary>
    /// Provides access to all Database Write operations needed for BASEL - LGD - Delinquent (Numeric).
    /// </summary>
    internal class LgdDqNumWriter
    {
        ...
        public async Task InsertRecordAsync(LgdDqNum newRecord)
        {
            ...
            await database.CreateStoredProcedureCommand(BaselDataAccessConstants.SP_ADD_LGD_DQ_NUM)
