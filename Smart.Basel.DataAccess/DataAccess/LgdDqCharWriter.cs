...
{
    /// <summary>
    /// Provides access to all Database Write operations needed for BASEL - LGD - Delinquent (Characters).
    /// </summary>
    internal class LgdDqCharWriter
    {
        ...
        public async Task InsertRecordAsync(LgdDqChar newRecord)
        {
            ...
            await database.CreateStoredProcedureCommand(BaselDataAccessConstants.SP_ADD_LGD_DQ_CHAR)
